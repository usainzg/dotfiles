...
vim.keymap.set('n', '<leader>lD', vim.diagnostic.goto_prev, { noremap = true, silent = true, desc = 'Go to previous diagnostics error' })

vim.keymap.set('n', '<leader>ld', vim.diagnostic.goto_next, { noremap = true, silent = true, desc = 'Go to next diagnostics error' })
